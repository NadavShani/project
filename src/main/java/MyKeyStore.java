...
public class MyKeyStore {
    ...
    public void createSelfSignedCertificate() throws KeyStoreException, NoSuchAlgorithmException {
        ...
        try {
            ...
            // Certificate[] chain = {this.generateCertificate("cn=TcpEncrypt", keyPair, 365, "SHA256withRSA")}; //CHAIN CERTIFICATE
            X509Certificate cert = this.generateCertificate("cn=TcpEncrypt", keyPair, 365, "SHA256withRSA"); //CHAIN CERTIFICATE
            //  keyStore.setKeyEntry("TcpEncrypt", keyPair.getPrivate(), this.password.toCharArray(), chain); //SAVE ENTRY IN STORE
            keyStore.setCertificateEntry("TcpEncrypt", cert);
    ...
    */
    ...
    public static void main(String[] args) throws KeyStoreException, NoSuchAlgorithmException {
        MyKeyStore myKeyStore = new MyKeyStore("store","123456");
